...
<html>
    <head>
        ...
        <title><?php echo $lang[$_COOKIE['systec_lang']]['reset']; ?></title>
        <!-- Bootstrap CSS -->    
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li><?php echo $lang[$_COOKIE['systec_lang']]['reset']; ?></li>
                            </ol>
                        </div>
                    </div>
                    <h2 class="sub-header">
                        <?php echo $lang[$_COOKIE['systec_lang']]['reset']; ?>
                    </h2>
                    <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                            <td><?php echo $lang[$_COOKIE['systec_lang']]['reset']; ?></td>
                            <td>
                                <button type="button" class="btn btn-primary" data-toggle='modal' data-target='#del_com' id="edit_submit">
                                    <?php echo $lang[$_COOKIE['systec_lang']]['reset_btn']; ?>
                                </button>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h4><?php echo $lang[$_COOKIE['systec_lang']]['factory_tips']; ?></h4>
            </div>
...
<script>
    ...
    function confirm_del() {
        ...
        $.post("/api/factory/reset",{hostname:$("#hostname").val(),mac:$("#mac").val(),ip:$("#ip").val(),gateway:$("#gateway").val(),netmask:$("#netmask").val(),dns:$("#dns").val(),dhcp:$("#dhcp").val()},function(result){
            if(result.state==0){
                logout();
